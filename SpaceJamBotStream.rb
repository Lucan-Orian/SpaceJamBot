...
SPACEJAM_TRIGGERS =["come on and slam","come on and slam and welcome to the jam", "hey you","party people in the house lets go", "pass that thing and watch me flex","to the jam all in your face", "drop it rock it down the room", "just work that body work that body", "get wild and lose your mind", 
...
streaming do
	replies do |user_tweet|
		...
		if SPACEJAM_TRIGGERS.any? {|quote| slam_text.include? quote}
